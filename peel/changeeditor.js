...
$.widget( "wtw.changeEditor", {
    ...
    defaultOptions: {
        ...
        changes:[
            {type:'modify', uid: 937, values: ['blah','foo'], summary:'to-be-generated' },
            {type:'delete', uid: 840, values: ['bxxx','yyy'], summary:'to-be-generated' }
        ],
        ...
        config: {
            ...
            uidLabels:{937:'Are you over 65?',840:'Expiry Date'},
        },
    },
    ...
    setChangeValue : function($action, change, index) {
        ...
        var $input = this.getChangeInput(this.options, change.uid);
...
//    getChangeInput(change);
    ...
    defaultOnChangeAdded : function($changeItem, options, change) {
        ...
        var vw = this.viewChange.bind(this);
        var scv = this.setChangeValue.bind(this);

        $actions.find('.change-accept').click(function(e) {
            scv($(this), change, 0)
        });
        $actions.find('.change-reject').click(function(e) {
            scv($(this), change, 1)
        });
        $changeItem.click(function(e) {
            vw($changeItem, change, options);
        });
    },
